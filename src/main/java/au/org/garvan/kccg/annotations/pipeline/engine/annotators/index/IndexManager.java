...
//
//import au.org.garvan.kccg.annotations.pipeline.engine.annotators.index.datasource.DataSourceManager;
...
//
//	public static IndexManager getInstance(Properties properties, TAPipeline taPipeline) {
//		if (instance == null) {
//			instance = new IndexManager(properties, taPipeline);
//		}
//
//		return instance;
//	}
//
//	private IndexManager(Properties properties, TAPipeline taPipeline) {
